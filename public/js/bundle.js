...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    //id of element to put map on
    style: 'mapbox://styles/av-rubinchik/ck8vwfjfd1tv71imoyzo0grcu',
    //create a style on website and copy a link
    scrollZoom: false // center: [-118.503637, 34.045417],
    // zoom: 10,
    // interactive: false
...
var stripe = Stripe('pk_test_bw2zCTzJwOV3BnWmWT9fnwT500gitWFxBX');
...
var btnSaveSettings = document.querySelector('.btn-save-seetings');
var btnSavePassword = document.querySelector('.btn-save-password');
var btnBook = document.getElementById('book-tour'); //MAPBOX
...
if (updatePasswordForm) {
  btnSavePassword.addEventListener('click', /*#__PURE__*/function () {
